...
//         const secureBaseIp = baseIp.replace('http://', 'https://');
//         return `${secureBaseIp}/${cgiUrl}?loginuse=${loginuser}&loginpas=${encodeURIComponent(loginpass)}`;
//     };
...
const CCTV: React.FC = () => {
    return (
        <iframe
            src="http://ecobotdashboard1.co.kr:3100/d-solo/e50c76e3-793c-4f03-9232-6627f7df4cb2hh/dashboard-wq?orgId=4&refresh=5s&from=1720427477898&to=1720513877898&panelId=2"
